...
if full_details:
    SC2.Evaporator_LT.Compute_Area(plot=True, save=True, name_cycle=SC2.name)
    SC2.Evaporator_MT.Compute_Area(plot=True, save=True, name_cycle=SC2.name)
    SC2.Condenser.Compute_Area(plot=True, save=True, name_cycle=SC2.name)
