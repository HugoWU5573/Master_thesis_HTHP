...
SC2R.Evaporator_LT = HEX_Design(states_in=[SC2R.state_10, SC2R.state_1_prime], states_out=[SC2R.state_1, SC2R.state_2_prime], mdot = [SC2R.mdot_wf_bottom, None], name="Evaporator_LT", mode="Dimensional", model="ACP70X")
T_pinch_evap_LT = SC2R.Evaporator_LT.Compute_Pinch()
SC2R.mdot_LT = SC2R.Evaporator_LT.mdot_h
SC2R.Evaporator_MT = HEX_Design(states_in=[SC2R.state_8, SC2R.state_3_prime], states_out=[SC2R.state_3_evap, SC2R.state_4_prime],mdot = [SC2R.mdot_wf_top - SC2R.mdot_wf_bottom, None], name="Evaporator_MT", mode="Dimensional", model="ACP70X")
T_pinch_evap_MT = SC2R.Evaporator_MT.Compute_Pinch()
SC2R.mdot_MT = SC2R.Evaporator_MT.mdot_h
SC2R.Condenser = HEX_Design(states_in=[SC2R.state_5_prime, SC2R.state_5], states_out=[SC2R.state_6_prime, SC2R.state_6], mdot=[None, SC2R.mdot_wf_top], name="Condenser", mode="Dimensional", model="ACP70X")
T_pinch_cond = SC2R.Condenser.Compute_Pinch()
SC2R.mdot_HT = SC2R.Condenser.mdot_c
SC2R.Recuperator_2 = HEX_Design(states_in=[SC2R.state_3, SC2R.state_6], states_out=[SC2R.state_4, SC2R.state_7], mdot=[SC2R.mdot_wf_top, SC2R.mdot_wf_top], name="Recuperator_1", mode="Dimensional", type="Recuperator", epsilon=recuperator_effectiveness, model="ACK18")
SC2R.Recuperator_2.Solve_Recuperator()
SC2R.Recuperator_1 = HEX_Design(states_in=[SC2R.state_1, SC2R.state_7], states_out=[SC2R.state_2, SC2R.state_9], mdot=[SC2R.mdot_wf_bottom, SC2R.mdot_wf_bottom], name="Recuperator_2", mode="Dimensional", type="Recuperator", epsilon=recuperator_effectiveness, model="ACK18")
SC2R.Recuperator_1.Solve_Recuperator()
