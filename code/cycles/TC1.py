...
TC1.Evaporator = HEX_Design(states_in=[TC1.state_8, TC1.state_3_prime], states_out=[TC1.state_3, TC1.state_4_prime], mdot=[TC1.mdot_wf_top, None], name="Evaporator", mode="Dimensional", model="ACP70X")
T_pinch_evap = TC1.Evaporator.Compute_Pinch()
TC1.mdot_MT = TC1.Evaporator.mdot_h
TC1.GasCooler = HEX_Design(states_in=[TC1.state_5_prime, TC1.state_5], states_out=[TC1.state_6_prime, TC1.state_7], mdot=[None, TC1.mdot_wf_top], name="Gas Cooler", mode="Dimensional", model="ACP70X")
