...
from code.cycles.thermodynamic.SC1 import run_SC1_cycle
...
def evaluate(x_in, params = []):
    ...
    try :
        log_A_evap, log_A_cond = run_SC1_cycle(sample, verbose=False, print_results=False, plot_results=False, save_results=False)
        
        return float(log_A_evap), float(log_A_cond)
