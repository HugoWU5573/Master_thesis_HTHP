...
In \cite{kosmadakis2024industrial}, it is reported that the waste heat potential in the EU-27
 and the UK reached 221.32 TWh/year in 2021. In comparison, the demand for heat below 140°C 
...
recovering waste heat from industrial processes. In \cite{arpagaus2018high}, the authors 
provide a list of manufacturers and universities that have already been working on the design 
of several machines for at least one decade. The existing machines cover a large spectrum of 
...
This thesis aims to design the thermodynamic cycle of 
a transcritical dual-evaporator HTHP, construct the machine, 
and evaluate its performance under laboratory conditions. 
The schematic of the cycle is provided in Figure \ref{fig:schematic} for reference.
