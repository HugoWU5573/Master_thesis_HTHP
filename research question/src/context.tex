...
The main purpose of this work is to design the thermodynamic cycle of a transcritical 
dual-evaporator HTHP, build it, and test its performance under laboratory conditions. 
No similar applications were found in the literature. Moreover, the machine built in the 
framework of this master’s thesis should be used in the future for academic purposes.