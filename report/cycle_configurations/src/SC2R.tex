...
in Figure \ref{fig:SC2R} and the corresponding operating conditions are summarized in Table 
\ref{tab:SC2R_conditions}.
...
\hline
\end{tabular}
\caption{Operating conditions for the SC2R cycle}
\label{tab:SC2R_conditions}
\end{table}
