...
in Figure \ref{fig:TC2} and the corresponding operating conditions are summarized in Table 
\ref{tab:TC2_conditions}.
...
\hline
\end{tabular}
\caption{Operating conditions for the TC2 cycle}
\label{tab:TC2_conditions}
\end{table}
